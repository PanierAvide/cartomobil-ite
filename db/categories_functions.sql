...
BEGIN
	...
	ELSIF tags->'obstacle:wheelchair' = 'yes' AND tags->'natural' = 'tree' AND tags->'cat2' = 'barrier' THEN
		result := 'tree';
	ELSIF tags->'barrier' = 'kerb' AND tags->'kerb' = 'raised' AND tags->'cat2' = 'barrier' THEN
		result := 'kerb';
