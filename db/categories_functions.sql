...
BEGIN
	...
	ELSIF (tags->'office' = 'company' AND tags->'name' IN ('Electricité de Tahiti', 'EDT', 'Électricité de Tahiti')) OR (tags->'office' = 'company' AND tags->'short_name' = 'EDT') OR (tags->'amenity' = 'vending_machine' AND tags->'vending' = 'condoms') OR (tags->'shop' IN ('frozen_food', 'supermarket', 'butcher', 'cheese', 'convenience', 'general', 'seafood', 'greengrocer', 'deli', 'spices', 'honey', 'pasta', 'cannery', 'tea', 'coffee', 'health_food', 'dairy', 'confectionery', 'chocolate', 'farm', 'bakery', 'pastry', 'alcohol', 'beverages', 'wine', 'winery', 'boutique', 'clothes', 'fashion', 'shoes', 'bag', 'jewelry', 'tailor', 'watches', 'fishing', 'hunting', 'sports', 'outdoor', 'beauty', 'cosmetics', 'hairdresser', 'massage', 'perfumery', 'chemist', 'tattoo', 'fabric', 'sewing', 'haberdashery', 'wool', 'art', 'music', 'musical_instrument', 'photo', 'craft', 'camera', 'video', 'video_games', 'stationery', 'printer_ink', 'books', 'kiosk', 'newsagent', 'medical_supply', 'optician', 'hearing_aids', 'variety_store', 'department_store', 'wholesale', 'second_hand', 'charity', 'bathroom_furnishing', 'carpet', 'curtain', 'furniture', 'kitchen', 'houseware', 'interior_decoration', 'pottery', 'lighting', 'bed', 'doityourself', 'electrical', 'fireplace', 'glaziery', 'hardware', 'paint', 'tiles', 'obile_phone', 'computer', 'electronics', 'appliance', 'hifi')) OR (tags->'amenity' = 'marketplace') OR (tags->'craft' != '') THEN
		result := 'shop';
	ELSIF (tags->'amenity' = 'school' AND tags->'school:FR' IN ('élémentaire', 'maternelle', 'primaire')) OR (tags->'amenity' = 'school' AND tags->'school:FR' = 'collège') OR (tags->'amenity' = 'school' AND tags->'school:FR' = 'lycée') OR (tags->'amenity' IN ('kindergarten', 'university', 'college')) THEN
		result := 'education';
...
BEGIN
	...
	ELSIF tags->'amenity' = 'community_centre' THEN
		result := 'community_centre';
	...
	ELSIF (tags->'highway' = 'bus_stop') OR (tags->'amenity' = 'bus_station') OR (tags->'public_transport' IN ('stop_position', 'platform') AND tags->'bus' = 'yes') THEN
		result := 'bus_stop';
	ELSIF (tags->'obstacle:wheelchair' = 'yes' AND tags->'amenity' = 'parking' AND tags->'informal' = 'yes') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'landuse' = 'construction') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'power' = 'pole') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'highway' IN ('street_lamp', 'traffic_signals')) OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'barrier' IN ('bollard', 'cycle_barrier', 'block', 'kerb')) OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'traffic_sign' != '') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'tourism' = 'information') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'natural' = 'tree') OR (tags->'barrier' = 'kerb' AND tags->'kerb' = 'raised') OR (tags->'highway' != '' AND tags->'smoothness' IN ('bad', 'very_bad', 'horrible', 'very_horrible', 'impassable')) OR (tags->'highway' != '' AND tags->'surface' IN ('metal', 'wood', 'compacted', 'fine_gravel', 'unhewn_cobblestone', 'sand', 'ground')) OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'fixme' != '') THEN
		result := 'barrier';
	...
	ELSIF tags->'tourism' = 'artwork' THEN
		result := 'artwork';
	ELSIF (tags->'historic' != '') OR (tags->'amenity' = 'marae') THEN
		result := 'historic';
	ELSE
		result := 'other';
	END IF;
...
BEGIN
	...
	ELSIF (tags->'obstacle:wheelchair' = 'yes' AND tags->'amenity' = 'parking' AND tags->'informal' = 'yes' AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'fixme' = 'Dessiner l''emprise du parking' AND tags->'cat2' = 'barrier') THEN
		result := 'informal_parking';
	ELSIF (tags->'obstacle:wheelchair' = 'yes' AND tags->'landuse' = 'construction' AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'fixme' = 'Dessiner l''emprise des travaux' AND tags->'cat2' = 'barrier') THEN
		result := 'roadworks';
	ELSIF (tags->'obstacle:wheelchair' = 'yes' AND tags->'power' = 'pole' AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'highway' IN ('street_lamp', 'traffic_signals') AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'barrier' IN ('bollard', 'cycle_barrier') AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'traffic_sign' != '' AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'tourism' = 'information' AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'fixme' = 'Intégrer le poteau au cheminement' AND tags->'cat2' = 'barrier') THEN
		result := 'pole';
	ELSIF tags->'obstacle:wheelchair' = 'yes' AND tags->'barrier' = 'block' AND tags->'cat2' = 'barrier' THEN
		result := 'block';
	ELSIF tags->'obstacle:wheelchair' = 'yes' AND tags->'natural' = 'tree' AND tags->'cat2' = 'barrier' THEN
		result := 'tree';
	ELSIF (tags->'barrier' = 'kerb' AND tags->'kerb' = 'raised' AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'barrier' = 'kerb' AND tags->'cat2' = 'barrier') THEN
		result := 'kerb';
	ELSIF (tags->'highway' != '' AND tags->'smoothness' IN ('bad', 'very_bad', 'horrible', 'very_horrible', 'impassable') AND tags->'cat2' = 'barrier') OR (tags->'highway' != '' AND tags->'surface' IN ('metal', 'wood', 'compacted', 'fine_gravel', 'unhewn_cobblestone', 'sand', 'ground') AND tags->'cat2' = 'barrier') OR (tags->'obstacle:wheelchair' = 'yes' AND tags->'fixme' = 'Intégrer les infos de revêtement au cheminement' AND tags->'cat2' = 'barrier') THEN
		result := 'surface';
	ELSE
		result := 'other';
	END IF;
