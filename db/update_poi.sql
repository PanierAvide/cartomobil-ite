...
WHERE
	...
	("amenity" IN ('atm', 'bank', 'bar', 'bus_station', 'cafe', 'car_rental', 'childcare', 'cinema', 'clinic', 'doctors', 'drinking_water', 'fast_food', 'ferry_terminal', 'fuel', 'hospital', 'ice_cream', 'kindergarten', 'letter_box', 'library', 'marketplace', 'nightclub', 'parking', 'parking_space', 'pharmacy', 'police', 'post_box', 'post_office', 'pub', 'restaurant', 'school', 'swimming_pool', 'taxi', 'theatre', 'toilets', 'townhall', 'vending_machine') OR "office" IN ('association', 'company', 'government', 'insurance') OR "shop" IN ('alcohol', 'appliance', 'art', 'bag', 'bakery', 'bathroom_furnishing', 'beauty', 'bed', 'beverages', 'books', 'boutique', 'butcher', 'cannery', 'carpet', 'charity', 'cheese', 'chemist', 'chocolate', 'clothes', 'coffee', 'computer', 'confectionery', 'convenience', 'cosmetics', 'curtain', 'dairy', 'deli', 'department_store', 'doityourself', 'electrical', 'electronics', 'fabric', 'farm', 'fashion', 'fireplace', 'fishing', 'frozen_food', 'furniture', 'gas', 'general', 'glaziery', 'greengrocer', 'haberdashery', 'hairdresser', 'hardware', 'health_food', 'hearing_aids', 'hifi', 'honey', 'houseware', 'hunting', 'insurance', 'interior_decoration', 'jewelry', 'kiosk', 'kitchen', 'lighting', 'massage', 'medical_supply', 'mobile_phone', 'music', 'musical_instrument', 'newsagent', 'optician', 'outdoor', 'paint', 'pasta', 'pastry', 'perfumery', 'photo', 'pottery', 'printer_ink', 'seafood', 'second_hand', 'sewing', 'shoes', 'spices', 'sports', 'stationery', 'supermarket', 'tailor', 'tea', 'tiles', 'toys', 'variety_store', 'video', 'video_games', 'watches', 'wholesale', 'wine', 'winery', 'wool') OR "tourism" IN ('artwork', 'guest_house', 'hostel', 'hotel', 'museum', 'viewpoint') OR "leisure" IN ('beach_resort', 'park', 'sports_centre', 'swimming_pool') OR "club" IN ('sport') OR "craft" IN ('electronics_repair', 'optician', 'sewing') OR "name" IN ('EDT', 'Electricité de Tahiti', 'Électricité de Tahiti') OR "school:FR" IN ('collège', 'lycée', 'maternelle', 'primaire', 'élémentaire') OR "healthcare" IN ('audiologist', 'centre', 'clinic', 'dentist', 'doctor', 'hospital', 'midwife', 'nurse', 'occupational_therapist', 'physiotherapist', 'podiatrist', 'psychotherapist', 'rehabilitation', 'speech_therapist') OR "highway" IN ('bus_stop') OR "public_transport" IN ('platform', 'stop_position') OR "aeroway" IN ('aerodrome') OR "wheelchair" IN ('designated', 'yes') OR "natural" IN ('beach') OR "waterway" IN ('waterfall')) --CATEGORIES
UNION ALL
SELECT
